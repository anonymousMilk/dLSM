...
#ifndef STORAGE_dLSM_INCLUDE_OPTIONS_H_
#define STORAGE_dLSM_INCLUDE_OPTIONS_H_
...
struct dLSM_EXPORT Options {
  ...
  // dLSM will write up to this amount of bytes to a file before
...
struct dLSM_EXPORT ReadOptions {
  ReadOptions() = default;
...
#endif  // STORAGE_dLSM_INCLUDE_OPTIONS_H_
