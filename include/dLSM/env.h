...
//
// An Env is an interface used by the dLSM implementation to access
...
#ifndef STORAGE_dLSM_INCLUDE_ENV_H_
#define STORAGE_dLSM_INCLUDE_ENV_H_
...
// This workaround can be removed when dLSM::Env::DeleteFile is removed.
#if defined(_WIN32)
...
#undef DeleteFile
#define dLSM_DELETEFILE_UNDEFINED
...
class dLSM_EXPORT Env {
 public:
  ...
  //
  // The result of Default() belongs to dLSM and must never be deleted.
  static Env* Default();
  ...
  // the dLSM implementation) must be prepared to deal with
...
class dLSM_EXPORT SequentialFile {
 public:
...
class dLSM_EXPORT RandomAccessFile {
 public:
...
class dLSM_EXPORT WritableFile {
 public:
...
class dLSM_EXPORT EnvWrapper : public Env {
 public:
...
#if defined(_WIN32) && defined(dLSM_DELETEFILE_UNDEFINED)
#if defined(UNICODE)
#define DeleteFile DeleteFileW
#else
#define DeleteFile DeleteFileA
#endif  // defined(UNICODE)
#endif  // defined(_WIN32) && defined(dLSM_DELETEFILE_UNDEFINED)

#endif  // STORAGE_dLSM_INCLUDE_ENV_H_
